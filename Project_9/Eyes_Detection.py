import cv2
img=cv2.imread("photos/img7.jpg")
gry=cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)

sm=cv2.CascadeClassifier(r"C:\Users\Admin\AppData\Local\Programs\Python\Python311\Lib\site-packages\cv2\data\haarcascade_eye.xml")
...
for x,y,w,h in f:
    ...
    s=sm.detectMultiScale(roi_img,1.3,5)
